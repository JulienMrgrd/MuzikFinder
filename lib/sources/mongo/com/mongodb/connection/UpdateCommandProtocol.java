...
class UpdateCommandProtocol extends WriteCommandProtocol {
    ...
    private static final sources.mongo.com.mongodb.diagnostics.logging.Logger LOGGER = Loggers.getLogger("protocol.update");
    ...
    @Override
    protected sources.mongo.com.mongodb.diagnostics.logging.Logger getLogger() {
        return LOGGER;
    }
