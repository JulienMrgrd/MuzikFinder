...
package sources.mongo.org.bson;
...
public interface BSONCallback {
     ...
     * @see sources.mongo.org.bson.BsonType#NULL
     */
    void gotNull(String name);

    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#UNDEFINED} value.
     *
     * @param name the name of the field
     * @see sources.mongo.org.bson.BsonType#UNDEFINED
     */
    void gotUndefined(String name);

    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#MIN_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#MAX_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#BOOLEAN} value.
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#DOUBLE} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#INT32} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#INT64} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#DATE_TIME} value.
     *
     * @param name   the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#STRING} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#SYMBOL} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#REGULAR_EXPRESSION} value.
     *
     * @param name    the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#TIMESTAMP} value.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#OBJECT_ID} value.
     *
     * @param name the name of the field
    ...
    /**
     * Invoked when {@link sources.mongo.org.bson.BSONDecoder} encountered a {@link sources.mongo.org.bson.BsonType#DB_POINTER} type field in a byte sequence.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#BINARY} value. Note that binary values have a subtype, which may
     * determine how the value is processed.
     *
     * @param name the name of the field
     * @param type one of the binary subtypes: {@link sources.mongo.org.bson.BsonBinarySubType}
     * @param data the field's value
     */
     ...
     * {@link sources.mongo.org.bson.BsonBinarySubType#UUID_LEGACY}
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#JAVASCRIPT} value.
     *
     * @param name the name of the field
    ...
    /**
     * Called when reading a field with a {@link sources.mongo.org.bson.BsonType#JAVASCRIPT_WITH_SCOPE} value.
     *
     * @param name  the name of the field
     * @param code  the JavaScript code
