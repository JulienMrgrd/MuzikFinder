...
package sources.mongo.com.mongodb.gridfs;
...
public class GridFS {
     ...
     *
     * @deprecated You can calculate max chunkSize with a similar formula {@link sources.mongo.com.mongodb.MongoClient#getMaxBsonObjectSize()} - 500*1000.
     ...
     * @throws sources.mongo.com.mongodb.MongoException if there's a failure
     * @see sources.mongo.com.mongodb.WriteConcern
     */
     ...
     * @throws sources.mongo.com.mongodb.MongoException if the operation fails
     */
    ...
    /**
     * Creates a file entry. After calling this method, you have to call {@link sources.mongo.com.mongodb.gridfs.GridFSInputFile#save()}.
     *
