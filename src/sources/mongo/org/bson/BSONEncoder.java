 ...
 *
 * <p>This class is a part of legacy API. Please check {@link sources.mongo.org.bson.codecs.Encoder} for a new one.</p>
 */
public interface BSONEncoder {
     ...
     * <ul>
     * <li>{@link #set(sources.mongo.org.bson.io.OutputBuffer)}</li>
