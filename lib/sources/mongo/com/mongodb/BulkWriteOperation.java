 ...
 * @see sources.mongo.com.mongodb.DBCollection#initializeUnorderedBulkOperation()
 *
...
public class BulkWriteOperation {
     ...
     * @throws sources.mongo.com.mongodb.BulkWriteException if the write failed due some other failure specific to the write command
