...
import sources.mongo.com.mongodb.client.model.BulkWriteOptions;
import sources.mongo.com.mongodb.client.model.CountOptions;
import sources.mongo.com.mongodb.client.model.FindOneAndDeleteOptions;
import sources.mongo.com.mongodb.client.model.FindOneAndReplaceOptions;
import sources.mongo.com.mongodb.client.model.FindOneAndUpdateOptions;
import sources.mongo.com.mongodb.client.model.IndexModel;
import sources.mongo.com.mongodb.client.model.IndexOptions;
import sources.mongo.com.mongodb.client.model.InsertManyOptions;
import sources.mongo.com.mongodb.client.model.RenameCollectionOptions;
import sources.mongo.com.mongodb.client.model.UpdateOptions;
import sources.mongo.com.mongodb.client.model.WriteModel;
import sources.mongo.com.mongodb.client.result.DeleteResult;
import sources.mongo.com.mongodb.client.result.UpdateResult;
...
public interface MongoCollection<TDocument> {
     ...
     *
     * @return the {@link sources.mongo.org.bson.codecs.configuration.CodecRegistry}
     */
     ...
     *
     * @return the {@link sources.mongo.com.mongodb.ReadPreference}
     */
     ...
     *
     * @return the {@link sources.mongo.com.mongodb.WriteConcern}
     */
     ...
     *
     * @param codecRegistry the new {@link sources.mongo.org.bson.codecs.configuration.CodecRegistry} for the collection
     ...
     *
     * @param readPreference the new {@link sources.mongo.com.mongodb.ReadPreference} for the collection
     ...
     *
     * @param writeConcern the new {@link sources.mongo.com.mongodb.WriteConcern} for the collection
     ...
     * @throws sources.mongo.com.mongodb.MongoBulkWriteException if there's an exception in the bulk write operation
     * @throws sources.mongo.com.mongodb.MongoException          if there's an exception running the operation
     */
     ...
     * @throws sources.mongo.com.mongodb.MongoWriteException        if the write failed due some other failure specific to the insert command
     * @throws sources.mongo.com.mongodb.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws sources.mongo.com.mongodb.MongoException             if the write failed due some other failure
     */
     ...
     * @throws sources.mongo.com.mongodb.MongoBulkWriteException if there's an exception in the bulk write operation
     * @throws sources.mongo.com.mongodb.MongoException          if the write failed due some other failure
     * @see sources.mongo.com.mongodb.client.MongoCollection#bulkWrite
     */
     ...
     * @throws sources.mongo.com.mongodb.WriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws sources.mongo.com.mongodb.MongoException        if the write failed due some other failure
     */
     ...
     * @throws sources.mongo.com.mongodb.MongoWriteException        if the write failed due some other failure specific to the delete command
     * @throws sources.mongo.com.mongodb.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws sources.mongo.com.mongodb.MongoException             if the write failed due some other failure
     */
     ...
     * @throws sources.mongo.com.mongodb.MongoWriteException        if the write failed due some other failure specific to the replace command
     * @throws sources.mongo.com.mongodb.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws sources.mongo.com.mongodb.MongoException             if the write failed due some other failure
     ...
     * @throws sources.mongo.com.mongodb.MongoWriteException        if the write failed due some other failure specific to the update command
     * @throws sources.mongo.com.mongodb.MongoWriteConcernException if the write failed due being unable to fulfil the write concern
     * @throws sources.mongo.com.mongodb.MongoException             if the write failed due some other failure
     ...
     * @throws sources.mongo.com.mongodb.MongoServerException if you provide a newCollectionName that is the name of an existing collection, or if the
     ...
     * @throws sources.mongo.com.mongodb.MongoServerException if you provide a newCollectionName that is the name of an existing collection and dropTarget
