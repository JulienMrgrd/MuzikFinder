...
import static sources.mongo.org.bson.assertions.Assertions.notNull;
...
import sources.mongo.org.bson.codecs.DocumentCodec;
...
public class Document implements Map<String, Object>, Serializable, Bson {
     ...
     * @throws sources.mongo.org.bson.codecs.configuration.CodecConfigurationException if the document contains types not in the default registry
     */
     ...
     * @return a JSON representation of this document
     * @throws sources.mongo.org.bson.codecs.configuration.CodecConfigurationException if the registry does not contain a codec for the document values.
     */
