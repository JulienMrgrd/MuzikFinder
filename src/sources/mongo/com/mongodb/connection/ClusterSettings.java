...
import sources.mongo.com.mongodb.ConnectionString;
...
public final class ClusterSettings {
    ...
    public static final class Builder {
         ...
         * {@link sources.mongo.com.mongodb.MongoTimeoutException} will be thrown.  The default value is 30 seconds.
         *
     ...
     * @see Cluster#selectServer(sources.mongo.com.mongodb.selector.ServerSelector)
     */
     ...
     * handle a request, a {@link sources.mongo.com.mongodb.MongoTimeoutException} will be thrown.  The default value is 30 seconds.
     *
     * <p> A value of 0 means that it will timeout immediately if no server is available.  A negative value means to wait
     * indefinitely.</p>
     *
