...
public abstract class AbstractBsonReader implements Closeable, BsonReader {
    ...
    /**
     * Returns the next {@code State} to transition to, based on the {@link sources.mongo.org.bson.AbstractBsonReader.Context} of this reader.
     *
     ...
     * reader. Also records the {@link sources.mongo.org.bson.BsonContextType}, indicating whether the reader is reading a document, array, or other
