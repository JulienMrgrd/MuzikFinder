...
import sources.mongo.com.mongodb.bulk.WriteRequest;
import sources.mongo.com.mongodb.client.AggregateIterable;
import sources.mongo.com.mongodb.client.DistinctIterable;
import sources.mongo.com.mongodb.client.FindIterable;
import sources.mongo.com.mongodb.client.ListIndexesIterable;
import sources.mongo.com.mongodb.client.MapReduceIterable;
...
import sources.mongo.com.mongodb.client.model.DeleteManyModel;
import sources.mongo.com.mongodb.client.model.DeleteOneModel;
...
import sources.mongo.com.mongodb.client.model.FindOptions;
...
import sources.mongo.com.mongodb.client.model.InsertOneModel;
import sources.mongo.com.mongodb.client.model.RenameCollectionOptions;
import sources.mongo.com.mongodb.client.model.ReplaceOneModel;
import sources.mongo.com.mongodb.client.model.ReturnDocument;
import sources.mongo.com.mongodb.client.model.UpdateManyModel;
import sources.mongo.com.mongodb.client.model.UpdateOneModel;
...
import sources.mongo.org.bson.codecs.CollectibleCodec;
...
class MongoCollectionImpl<TDocument> implements MongoCollection<TDocument> {
    ...
    private DeleteResult delete(final Bson filter, final boolean multi) {
        sources.mongo.com.mongodb.bulk.BulkWriteResult result = executeSingleWriteRequest(new DeleteRequest(toBsonDocument(filter)).multi(multi));
    ...
    private UpdateResult toUpdateResult(final sources.mongo.com.mongodb.bulk.BulkWriteResult result) {
        if (result.wasAcknowledged()) {
