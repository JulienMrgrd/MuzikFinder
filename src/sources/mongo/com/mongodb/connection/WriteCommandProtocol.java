...
import static sources.mongo.com.mongodb.connection.ProtocolHelper.getCommandFailureException;
import static sources.mongo.com.mongodb.connection.ProtocolHelper.getMessageSettings;
import static sources.mongo.com.mongodb.connection.WriteCommandResultHelper.getBulkWriteException;
import static sources.mongo.com.mongodb.connection.WriteCommandResultHelper.getBulkWriteResult;
...
abstract class WriteCommandProtocol implements Protocol<BulkWriteResult> {
     ...
     * @return the logger
     */
    protected abstract sources.mongo.com.mongodb.diagnostics.logging.Logger getLogger();
