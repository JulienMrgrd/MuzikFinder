...
import sources.mongo.com.mongodb.MongoBulkWriteException;
import sources.mongo.com.mongodb.MongoNamespace;
import sources.mongo.com.mongodb.WriteConcern;
import sources.mongo.com.mongodb.WriteConcernException;
...
import sources.mongo.com.mongodb.bulk.BulkWriteError;
import sources.mongo.com.mongodb.bulk.BulkWriteResult;
import sources.mongo.com.mongodb.bulk.BulkWriteUpsert;
...
import sources.mongo.com.mongodb.bulk.WriteConcernError;
import sources.mongo.com.mongodb.bulk.WriteRequest;
import sources.mongo.com.mongodb.connection.AsyncConnection;
import sources.mongo.com.mongodb.connection.BulkWriteBatchCombiner;
import sources.mongo.com.mongodb.connection.Connection;
import sources.mongo.com.mongodb.connection.ConnectionDescription;
import sources.mongo.com.mongodb.connection.ServerVersion;
import sources.mongo.com.mongodb.internal.connection.IndexMap;
...
import static sources.mongo.com.mongodb.assertions.Assertions.isTrueArgument;
import static sources.mongo.com.mongodb.assertions.Assertions.notNull;
import static sources.mongo.com.mongodb.bulk.WriteRequest.Type.DELETE;
import static sources.mongo.com.mongodb.bulk.WriteRequest.Type.INSERT;
import static sources.mongo.com.mongodb.bulk.WriteRequest.Type.REPLACE;
import static sources.mongo.com.mongodb.bulk.WriteRequest.Type.UPDATE;
...
public class MixedBulkWriteOperation implements AsyncWriteOperation<BulkWriteResult>, WriteOperation<BulkWriteResult> {
     ...
     * @throws sources.mongo.com.mongodb.MongoBulkWriteException if a failure to complete the bulk write is detected based on the server response
     */
    @Override
