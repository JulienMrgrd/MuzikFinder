...
import sources.mongo.com.mongodb.annotations.NotThreadSafe;
import sources.mongo.com.mongodb.client.MongoCursor;
...
import static sources.mongo.com.mongodb.DBObjects.toDBObject;
...
public class DBCursor implements Cursor, Iterable<DBObject> {
     ...
     * @return {@code this} so calls can be chained
     *
     * @see sources.mongo.com.mongodb.DBCursor#sort(DBObject)
     * @see sources.mongo.com.mongodb.DBCursor#hint(DBObject)
     ...
     * @deprecated Replaced with {@link sources.mongo.com.mongodb.ReadPreference#secondaryPreferred()}
     */
    @Deprecated
